 ...
 * *****************************************************************************************/
    ...
    */
    ...
    /*
    * Place the task represented by pxTCB into the appropriate ready list for
    * the task.  It is inserted at the appropriate place based on its deadline
    */
    #define prvAddTaskToReadyList( pxTCB )                                                                 \
        traceMOVED_TASK_TO_READY_STATE( pxTCB );                                                           \
            ...
            for( ; ; )
            {
                ...
                else
                {
                    ...
                    *********************************************************************************/    
                    ...
                    #if( configUSE_EDF_SCHEDULER == 1)
                    /*Rescheduale the tasks deadlines have been changed */
...
static portTASK_FUNCTION( prvIdleTask, pvParameters )
{
    ...
    for( ; ; )
    {
         ...
         *******************************Missing Changes #1*********************************
         *********************************************************************************/    
        /*update the idle task deadline each loop*/
        #if( configUSE_EDF_SCHEDULER == 1)
        
        listSET_LIST_ITEM_VALUE( &( ( pxCurrentTCB )->xStateListItem ), 1000 + xTaskGetTickCount());
...
{
    /** THIS FUNCTION IS CALLED FROM THE RTOS IDLE Calling Initialization Function **/
