...
unsigned int task1_startTime = 0;
unsigned int task2_startTime = 0;
unsigned int task3_startTime = 0;
unsigned int task4_startTime = 0;
unsigned int task5_startTime = 0;
unsigned int task6_startTime = 0;

unsigned int system_totalTime=0;
unsigned int system_executionTime = 0;
...
TaskHandle_t Handler_temp_task= NULL;
